...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_NANO6
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  15.05
    #define DEFAULT_Ki   0.98
    #define DEFAULT_Kd 57.48
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 41.9
  #define DEFAULT_bedKi 7.59
  #define DEFAULT_bedKd 154.20
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 3500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50, -1, -1.2  }
...
// https://reprap.org/wiki/TOUCH_MISO_PIN12864
//
