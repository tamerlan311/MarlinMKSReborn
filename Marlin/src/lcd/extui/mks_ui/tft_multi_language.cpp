...
void disp_language_init() {
  ...
  switch (gCfgItems.language) {
    case LANG_SIMPLE_CHINESE:
      ...
      printing_MENU.filament            = PRINT_FILAMENT_CN;
      printing_MENU.layer_stop            = PRINT_LAYER_STOP_CN;
      printing_MENU.layer_to_stop           = PRINT_LAYER_TO_STOP_CN;
      printing_MENU.layer_num           = PRINT_LAYER_NUM_CN;
      printing_MENU.save           = PRINT_LAYER_NUM_SAVE_CN;
      ...
      printing_MENU.no_file_found       = NO_FILE_FOUND_T_CN;
          ...
          case LANG_ENGLISH:
            ...
            printing_MENU.filament            = PRINT_FILAMENT_EN;
            printing_MENU.layer_stop            = PRINT_LAYER_STOP_EN;
            printing_MENU.layer_to_stop           = PRINT_LAYER_TO_STOP_EN;
            printing_MENU.layer_num           = PRINT_LAYER_NUM_EN;
            printing_MENU.save           = PRINT_LAYER_NUM_SAVE_EN;
            //
            #if ENABLED(MKS_WIFI_MODULE)
              // tips
              tips_menu.joining      = TEXT_WIFI_JOINING_EN;
          ...
          case LANG_RUSSIAN:
            ...
            printing_MENU.layer_stop          = PRINT_LAYER_STOP_RU;
            printing_MENU.filament            = PRINT_FILAMENT_RU;
            printing_MENU.layer_to_stop       = PRINT_LAYER_TO_STOP_RU;
            printing_MENU.layer_num           = PRINT_LAYER_NUM_RU;
            printing_MENU.save                = PRINT_LAYER_NUM_SAVE_RU;
            ...
            main_menu.low          = LOW_RU;
            main_menu.high         = HIGH_RU;
            main_menu.stop         = STOP_RU;
            main_menu.Heating_nozzle = HEATING_NOZZLE_RU;
            // TOOL
            ...
            leveling_menu.zoffset   = Z_OFF_SET_RU;
            //
