...
void lv_draw_filament_change() {
  ...
  // lv_obj_set_pos(btnStop, 187, 214);
  lv_obj_align(btnStop, buttonIn, LV_ALIGN_CENTER, 0, 135);
  ...
  lv_obj_align(imgExt, buttonIn, LV_ALIGN_OUT_RIGHT_TOP, 20, 10);
  ...
  // lv_obj_set_pos(btnHeating, 340, 214);
  lv_obj_align(btnHeating, buttonOut, LV_ALIGN_CENTER, 0, 135);
