...
void lv_draw_manualLevel() {
  ...
  lv_label_set_text(labelname, tool_menu.TERN(AUTO_BED_LEVELING_BILINEAR, autoleveling, leveling));
  ...
  imgbackground = lv_obj_create(scr, nullptr);//lv_img_create(scr,NULL);
  // lv_img_set_src(imgbackground, "F:/bmp_leveling_bg.bin");
  ...
  // lv_obj_align(buttonZeroZ, imgbackground, LV_ALIGN_OUT_RIGHT_TOP, 0, 0);
